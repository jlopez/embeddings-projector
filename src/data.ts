...
import {numeric} from './third_party/numeric';
...
export class DataSet {
  ...
  projectPCA(): Promise<void> {
    ...
    return util.runAsyncTask('Computing PCA...', () => {
      ...
      // JLA type jumping...
      const scalar = dot(transpose(sampledVectors as any), sampledVectors as any);
      const sigma = div(scalar as any, sampledVectors.length);

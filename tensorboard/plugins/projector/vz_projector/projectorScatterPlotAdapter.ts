...
const GRAY_E3 = 0xe3e3e3;
const C64_PURPLE = 0x7575d9;
const FIERY_SALMON = 0xfa6666;
const VELVET = 0x760b4f;

const LABEL_FONT_SIZE = 10;
const LABEL_SCALE_DEFAULT = 1.0;
const LABEL_SCALE_LARGE = 2;
const LABEL_FILL_COLOR_SELECTED = BLACK;
const LABEL_FILL_COLOR_HOVER = BLACK;
const LABEL_FILL_COLOR_NEIGHBOR = BLACK;
const LABEL_STROKE_COLOR_SELECTED = WHITE;
const LABEL_STROKE_COLOR_HOVER = WHITE;
const LABEL_STROKE_COLOR_NEIGHBOR = WHITE;

const POINT_COLOR_UNSELECTED = GRAY_E3;
const POINT_COLOR_NO_SELECTION = C64_PURPLE;
const POINT_COLOR_SELECTED = FIERY_SALMON;
const POINT_COLOR_HOVER = VELVET;
...
const LABELS_3D_COLOR_UNSELECTED = WHITE;
const LABELS_3D_COLOR_NO_SELECTION = WHITE;

const SPRITE_IMAGE_COLOR_UNSELECTED = WHITE;
const SPRITE_IMAGE_COLOR_NO_SELECTION = WHITE;

...
export const template = html`
  ...
  <style>
    ...
    .generation-sandbox:before {
      content: '';
      float: left;
      padding-bottom: 100%;
    }

    .generation-sandbox:after {
      content: '';
      display: table;
      clear: both;
    }
    ...
    .generated-image {
      background-image: url('https://icons.iconarchive.com/icons/paomedia/small-n-flat/512/profile-icon.png');
